...
public class feedbackBoardInsertAnswerServiceImpl implements Service {
	...
	public ModelAndView request(HttpServletRequest req, HttpServletResponse resp) {
		...
		System.out.println("문의게시판 데이터 확인 : " + req.getParameter("boardNum") + " " + (String)session.getAttribute("user_email") + req.getParameter("answer"));
